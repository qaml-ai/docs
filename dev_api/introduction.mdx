...
<CardGroup cols={2}>
  <Card title="Multi-Tenant Row-Level Security" icon="shield-check">
    Easy data isolation with your own RLS policies.
  </Card>
  
  <Card title="Thread Management" icon="comment-dots">
...
<Card title="Ready to get started?" icon="rocket" href="/dev_api/camel-api-quickstart" horizontal>
