...
- [See detailed guide for adding a data source via API](/sources/add-connection)
...
- [See detailed guide for adding knowledge base entries via API](/knowledge-base/create-knowledge-base-entry)
...
- [See detailed guide for adding reference queries via API](/reference-queries/create-reference-query)
