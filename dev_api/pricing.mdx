...
<Note>
  camelAI is currently in beta. All users get our Professional plan for free. We will give all accounts 3-day notice before billing begins.
</Note>
...
<CardGroup cols={3}>
  ...
  <Card title="Professional" icon="rocket">
    <h3 className="text-2xl font-bold mb-2">$200<span className="text-sm font-normal">/month</span></h3>
...
- Access to OpenAI O4 Mini model only
...
- $10 in token credits included each month
