...
This guide explains how to create a superuser account for camelAI, which is required to access the admin interface and manage the application.
...
1. [Log in to camelAI](/first-steps/logging-in)
2. [Configure Initial Settings](/first-steps/initial-setup)
