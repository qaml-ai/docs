...
Return the models currently exposed by Camel Stream. The response is compatible
with OpenAI model discovery and also includes fields used by Anthropic gateway
discovery.
