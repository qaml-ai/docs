...
camelAI consists of several key components:

- `camel` – The main application that handles analysis and user interactions
- `nginx` – Reverse proxy for secure access
- `pgvector` – PostgreSQL with vector extension for efficient data storage
