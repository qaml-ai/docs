...
<CardGroup cols={1}>
  <Card title="Plans & pricing" icon="credit-card" href="/plans/overview" horizontal>
...
<CardGroup cols={3}>
  <Card title="camelAI Coding Agent" icon="code" href="/getting-started/quickstart">
    Chat with an agent that builds and deploys full-stack apps. You're reading
    its docs.
  </Card>
  <Card title="camelStream" icon="bolt" href="/stream/overview">
    Unlimited frontier intelligence at a flat monthly price.
  </Card>
  <Card title="Embedded Analytics (Legacy)" icon="chart-line" href="/dev_api/introduction">
    Retired iframe analytics product; docs kept for existing customers.
  </Card>
</CardGroup>
