...
Free tier requires an API key from one of [our supported providers](/plans/model-providers) before you can chat with the agent. Monthly credits don't carry over.
