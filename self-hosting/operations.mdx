...
Download `selfhost-release.json` and
`selfhost-upgrade-bootstrap.mjs` from the target release workflow artifact.
Keep both files outside the mutable repository checkout.
