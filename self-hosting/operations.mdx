...
Run all three smokes after initial installation, after an upgrade, and after a
...
The project smoke launches a build container and executes a small build. The
analysis smoke starts Jupyter and executes a notebook. The database-query smoke
loads and exercises the supported query drivers. Each command removes its
smoke container afterward.
...
7. Runs the doctor and all three attached-runtime smokes.
