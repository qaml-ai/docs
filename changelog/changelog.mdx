...
<Warning>
  Enterprise users must update their Claude API keys to Sonnet 4.0 before updating Docker.
</Warning>
...
<Tabs>
  <Tab title="Updates">
    ...
    - **Note:** Enterprise users must update their API keys before updating Docker
