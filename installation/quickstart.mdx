...
description: 'Deploy camelAI on your own infrastructure using Docker Compose'
---

<Warning>
  Self-hosting requires an Enterprise license. Most users should start with our [web app](/getting-started/web-app-quickstart) which has a free tier. [Contact sales](https://cal.com/ipr-camelai/book-a-demo) for self-hosting licensing.
</Warning>
